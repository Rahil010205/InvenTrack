        ...
        <div className="mt-4 space-y-4">
          {stats.recentActivity.length === 0 ? (
            ...
            stats.recentActivity.map((activity) => (
              <div key={activity.ledger_id} className="flex items-center justify-between border-b border-slate-100 pb-4 last:border-0 last:pb-0">
                <div>
                ...
                <span className={activity.quantity_change > 0 ? "text-green-600 font-bold" : "text-red-600 font-bold"}>

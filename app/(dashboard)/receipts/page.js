        ...
        renderRow={(receipt) => (
          <tr key={receipt.receipt_id} className="hover:bg-accent transition-colors">
            ...
            <td className="whitespace-nowrap px-6 py-4 text-sm text-muted-foreground">
              <span className="inline-flex items-center rounded-full bg-blue-600 text-white px-2.5 py-0.5 text-xs font-medium dark:bg-green-400 dark:text-green-900 transition-colors">
                {receipt.status}
              </span>
            </td>
